              ...
              <div class="">
                  ...
                  <div class="flex-1 flex flex-col items-center lg:items-end justify-end px-8 mt-2">
                      <div class="flex  items-center space-x-4 mt-2">
                          ...
                          <form action="{{ route('trainee.profile.image.update', $trainee->id) }}" method="POST" enctype="multipart/form-data" id="imageForm" class="flex items-center">
                            @csrf
                            @method('PUT')
                            <label for="file-upload" class="flex items-center cursor-pointer bg-gray-600 hover:bg-gray-700 text-gray-100 px-4 py-2 rounded text-sm transition duration-100">
                                ...
                                <span>Update</span>
                                <input id="file-upload" name="trainee_image" type="file" class="sr-only" onchange="document.getElementById('imageForm').submit()">
                            </label>
                        </form>
