...
<div class="container mx-auto p-4 h-screen">
    ...
    <form action="{{route('admin.companies.updateAnnounce' , $announce->id)}}" method="post" class="max-w-md mx-auto grid grid-cols-2 gap-4">
        ...
        <div class="mb-4 col-span-2">
            ...
            <input type="text" id="title" name="title"value="{{$announce->title}}"
        ...
        <div class="mb-4">
            ...
            <input type="text" id="description" name="description" value="{{ $announce->description }}"
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring focus:ring-blue-500">
                @error('description')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                @enderror
        ...
        <div class="mb-4">
            ...
            <input type="text" id="skills" name="skills" value="{{ $announce->skills }}"
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring focus:ring-blue-500">
                @error('skills')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                @enderror
        ...
        <div class="mb-4">
            ...
            <input type="text" id="contact" name="contact" value="{{ $announce->contact }}"
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring focus:ring-blue-500">
                @error('contact')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                @enderror
