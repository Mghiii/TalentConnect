...
Route::middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::put('admin/companies/announcements/update/{announce}', [AdminController::class, 'updateAnnounce'])->name('admin.companies.updateAnnounce');
    ...
    Route::get('admim/trainee/offre/edit/{offre}' , [AdminController::class , 'editOffre'])->name('admin.trainee.offre.edit');
    ...
    Route::get('admin/companies/internships/edit/{internship}' , [AdminController::class , 'editInternship'])->name('admin.companies.editInternship');
    ...
    Route::get('admin/trainee/{trainee}/internships', [AdminController::class, 'showTraineeInternships'])->name('admin.trainee.internships');
    Route::get('admin/trainee/internships/edit/{internship}' , [AdminController::class , 'traineeEditInternship'])->name('admin.trainee.editInternship');
    Route::put('admin/trainee/internship/update/{internship}' , [ AdminController::class , 'traineeUpdateInternship'])->name('admin.trainee.updateinternship');
    Route::delete('admin/trainee/internships/delete/{internship}' , [AdminController::class , 'traineeDestroyInternship'])->name('admin.trainee.internships.delete');
